...
namespace PlayList.Types
{
    ...
    public class Query
    {
        ...
        public IEnumerable<IPet> GetPets() =>
            ...
            {
                new Dog("dk", "dk"),
                new Cat("catea", CatLives.One),
                new Parrot("djie", true)
            };
        ...
        {
            _dog = !_dog;
            return _dog ? new Dog("buddy", "golden retriever") : new Cat("catea", CatLives.One);


        }
        public record Random(string Foo) : IMammal;
